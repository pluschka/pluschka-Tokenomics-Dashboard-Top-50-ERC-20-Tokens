...
import tokenBins from '../data/total_supply_chart.json';

export default function TokenBinsBarChart() {
    ...
    chartRef.current = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: 'rgba(35, 46, 63, 1)',
          borderColor: 'rgba(35, 46, 63, 1)',
          borderWidth: 1
        }]
      },
      options: {
            ...
            callbacks: {
              ...
              afterBody: (items) => {
                ...
                if (tokensInBin.length === 0) {
                  return ['Keine Tokens in diesem Bin'];
                }

                return tokensInBin.map(
                  t => `${t.name}: ${t.total_supply.toLocaleString('en-US')}`
                );
              }
            }
          }
